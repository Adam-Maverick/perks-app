...
export default function MerchantDisputePage() {
    return (
        <div className="max-w-2xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Merchant Dispute Portal</h1>
            <p className="text-gray-500 mb-6">
                This feature is coming soon. Currently, disputes are handled via email and admin review.
            </p>
